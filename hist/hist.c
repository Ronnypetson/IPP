...
int main(int argc, char * argv[]) {
	...
	long unsigned int duracao, duracao0;
	...
	duracao0 = ((end0.tv_sec * 1000000 + end0.tv_usec) - \
	(start0.tv_sec * 1000000 + start0.tv_usec));

	printf("Duracao total e fracao: %lu %f\n", duracao0, duracao*1.0/duracao0);
