...
#pragma omp parallel firstprivate(srcfiles,xres,yres,rpp,angle,destfiles)  num_threads(1)
  ...
  for (i = 0; i < qtdFiles; i++) {
    ...
    __start_iter_prof( (unsigned long)i);
    ...
    __stop_iter_prof( (unsigned long)i);
